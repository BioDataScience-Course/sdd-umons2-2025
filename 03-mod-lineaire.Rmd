...
-   L'ANOVA (`r course_link("module 9", course = 1, "variance")` & `r course_link("module 10", course = 1, "variance2")` du cours SDD 1), ainsi que la régression linéaire ([module 1](#lm) et [module 2](#lm2) du présent cours) doivent être maîtrisées avant d'aborder cette matière.
