...
```{r assign_B08Ib_zooscannet_I, echo=FALSE, results='asis'}
if (exists("assignment"))
...
#  babynames2 <- read$csv.bz2(csv_bz2_file)
#)[["elapsed"]])
...
```{r assign_B08Ib_zooscannet_II, echo=FALSE, results='asis'}
if (exists("assignment"))
...
```{r assign_B06Ga_open_data_III, echo=FALSE, results='asis'}
