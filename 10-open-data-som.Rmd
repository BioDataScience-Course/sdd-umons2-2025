...
## Données ouvertes {#donneesouvertes}
...
Le DOI ne couvre pas que les articles scientifiques, il est également utilisé pour les données. Par exemple, le DOI <https://doi.org/10.5281/zenodo.3711592> fait référence aux données intitulées *Dataset: Number of diagnoses with coronavirus disease (COVID-19) in The Netherlands* publié sur [Zenodo](https://zenodo.org), un site spécialisé dans le partage de données ouvertes. Nous y reviendrons dans les sections suivantes.
...
`r h5p(123, "B10Ha_license", height = 270, toc = "Choix de licence")`
...
`r h5p(124, "B10Hb_interoperable", height = 270, toc = "Choix du format des données")`
...
`r h5p(125, "B10Hc_fair", height = 270, toc = "Principe FAIR")`
...
`r h5p(98, "B10Hd_method", height = 270, toc = "Choix des méthodes")`
...
`r h5p(231, "B10He_size", height = 270, toc = "Nombre de cellules")`
...
`r h5p(232, "B10Hf_grid", height = 270, toc = "Topologie de la carte")`
...
`r h5p(233, "B10Hg_count", height = 270, toc = "Graphique des SOM")`
...
```{r assign_B06Ga_open_data_V, echo=FALSE, results='asis', purl=FALSE}
if (exists("assignment2"))
  assignment2("B06Ga_open_data", part = "V",
    ...
    term = "Q2", level = 4, n = 4,
    toc = "Étude de données ouvertes choisies librement (V)")
```


## Récapitulatif des exercices {#recapitulatifb10}
...
-  [Document HTML](more/10-open-data-som.html)
-  [Script R](https://github.com/BioDataScience-Course/sdd-umons2-2025/blob/main/R/10-open-data-som.R){target="top"}
